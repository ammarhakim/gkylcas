...
(provide generate-lax-friedrichs-vector2-1d-conditional
         generate-lax-friedrichs-vector2-1d-second-order-conditional
         generate-roe-vector2-1d-conditional
         generate-roe-vector2-1d-second-order-conditional)
 ...
 "Generate C code that solves the 1D coupled vector system of 2 PDEs specified by `pde-system` using the Lax-Friedrichs finite-difference method,
  ...
  (define conditions-local (flux-substitute (flux-substitute
                                             (flux-substitute (flux-substitute
                                                               (flux-substitute (flux-substitute conditions-code (list-ref cons-codes 0) "u[(i * 2) + 0]")
...
;; ------------------------------------------------------------------------------------------------------------------------------------------------------------------
;; Lax–Friedrichs (Finite-Difference) Solver for a 1D Coupled Vector System of 2 PDEs with a Second-Order Flux Extrapolation subject to certain algebraic constraints
;; ------------------------------------------------------------------------------------------------------------------------------------------------------------------
(define (generate-lax-friedrichs-vector2-1d-second-order-conditional pde-system limiter conds epsilon
                                                                     #:nx [nx 200]
                                                                     #:x0 [x0 0.0]
                                                                     #:x1 [x1 2.0]
                                                                     #:t-final [t-final 1.0]
...
// AUTO-GENERATED CODE FOR COUPLED VECTOR PDE SYSTEM: ~a
// FLUX LIMITER: ~a
// Lax–Friedrichs first-order finite-difference solver for a coupled vector system of 2 PDEs in 1D, with a second-order flux extrapolation subject to algebraic constraints.
...
(define (generate-roe-vector2-1d-conditional pde-system conds epsilon
 ...
 "Generate C code that solves the 1D coupled vector system of 2 PDEs specified by `pde-system` using the Roe finite-volume method,
  ...
  (define code
    (format "
// AUTO-GENERATED CODE FOR COUPLED VECTOR PDE SYSTEM: ~a
// Roe higher-order finite-volume solver for a coupled vector system of 2 PDEs in 1D subject to algebraic constraints.
...
;; ---------------------------------------------------------------------------------------------------------------------------------------------------
;; Roe (Finite-Volume) Solver for a 1D Coupled Vector System of 2 PDEs with a Second-Order Flux Extrapolation subject to certain algebraic constraints
;; ---------------------------------------------------------------------------------------------------------------------------------------------------
(define (generate-roe-vector2-1d-second-order-conditional pde-system limiter conds epsilon
                                                          #:nx [nx 200]
                                                          #:x0 [x0 0.0]
                                                          #:x1 [x1 2.0]
                                                          #:t-final [t-final 1.0]
 ...
 "Generate C code that solves the 1D coupled vector system of 2 PDEs specified by `pde-system` using the Roe finite-volume method with a
  second-order flux extrapolation using flux limiter `limiter`, subject to the algebra conditions `conds` with machine epsilon `epsilon`.
  - `nx` : Number of spatial cells.
  - `x0`, `x1` : Domain boundaries.
  - `t-final`: Final time.
  - `cfl`: CFL coefficient.
...
// AUTO-GENERATED CODE FOR COUPLED VECTOR PDE SYSTEM: ~a
// FLUX LIMITER: ~a
// Roe higher-order finite-volume solver for a coupled vector system of 2 PDEs in 1D, with a second-order flux extrapolation subject to algebraic constraints.
