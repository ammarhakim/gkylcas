...
(provide generate-lax-friedrichs-vector3-2d-conditional
         generate-lax-friedrichs-vector3-2d-second-order-conditional
         generate-roe-vector3-2d-conditional
         generate-roe-vector3-2d-second-order-conditional)
...
;; ------------------------------------------------------------------------------------------------------------------------------------------------------------------
;; Lax–Friedrichs (Finite-Difference) Solver for a 2D Coupled Vector System of 3 PDEs with a Second-Order Flux Extrapolation subject to certain algebraic constraints
;; ------------------------------------------------------------------------------------------------------------------------------------------------------------------
(define (generate-lax-friedrichs-vector3-2d-second-order-conditional pde-system limiter conds epsilon
                                                                     #:nx [nx 200]
                                                                     #:ny [ny 200]
                                                                     #:x0 [x0 0.0]
                                                                     #:x1 [x1 2.0]
 ...
 "Generate C code that solves the 2D coupled vector system of 3 PDEs specified by `pde-system` using the Lax-Friedrichs finite-difference method with a
  second-order flux extrapolation using flux limiter `limiter`, subject to the algebraic conditions `conds` with machine epsilon `epsilon`.
  - `nx`, `ny` : Number of spatial cells in each coordinate direction.
  - `x0`, `x1`, `y0`, `y1` : Domain boundaries in each coordinate direction.
  - `t-final`: Final time.
  - `cfl`: CFL coefficient.
...
// AUTO-GENERATED CODE FOR COUPLED VECTOR PDE SYSTEM: ~a
// FLUX LIMITER: ~a
// Lax–Friedrichs first-order finite-difference solver for a coupled vector system of 3 PDEs in 2D, with a second-order flux extrapolation subject to algebraic constraints.
...
(define (generate-roe-vector3-2d-conditional pde-system conds epsilon
 ...
 "Generate C code that solves the 2D coupled vector system of 3 PDEs specified by `pde-system` using the Roe finite-volume method,
  ...
  (define code
    (format "
// AUTO-GENERATED CODE FOR COUPLED VECTOR PDE SYSTEM: ~a
// Roe higher-order finite-volume solver for a coupled vector system of 3 PDEs in 2D subject to algebraic constraints.
...
;; ---------------------------------------------------------------------------------------------------------------------------------------------------
;; Roe (Finite-Volume) Solver for a 2D Coupled Vector System of 3 PDEs with a Second-Order Flux Extrapolation subject to certain algebraic constraints
;; ---------------------------------------------------------------------------------------------------------------------------------------------------
(define (generate-roe-vector3-2d-second-order-conditional pde-system limiter conds epsilon
                                                          #:nx [nx 200]
                                                          #:ny [ny 200]
                                                          #:x0 [x0 0.0]
                                                          #:x1 [x1 2.0]
...
// AUTO-GENERATED CODE FOR COUPLED VECTOR PDE SYSTEM: ~a
// FLUX LIMITER: ~a
// Roe higher-order finite-volume solver for a coupled vector system of 3 PDEs in 2D, with a second-order flux extrapolation subject to algebraic constraints.
