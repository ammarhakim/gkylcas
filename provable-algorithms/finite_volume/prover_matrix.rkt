...
(provide symbolic-jacobian
         ...
         prove-roe-vector3-1d-hyperbolicity
         prove-roe-vector3-1d-strict-hyperbolicity
         prove-roe-vector3-1d-flux-conservation)
...
(define (is-real expr cons-vars parameters)
  (match expr
    ...
    ;; Any non-negative number raised to the power of another real number is always real.
    [`(expt ,expr1 ,expr2)
     (and (is-non-negative expr1 cons-vars parameters) (is-real expr2 cons-vars parameters))]

    ;; Any complex number is real if its imaginary part is equal to 0 or 0.0.
    [`(make-rectangular ,expr1 ,expr2)
     (or (equal? expr2 0) (equal? expr2 0.0))]
    ...
    (cond
      ...
      [else
       (match matrix
         ...
         ;; Otherwise, return the most general (complex) solution.
         [else (list
                `(+ (+ (* (/ 1.0 3.0) (+ (+ ,a ,e) ,i)) (* (* (* (/ -1.0 3.0) (expt 2.0 (/ 1.0 3.0)))
                                                              (+ (+ (+ (+ (+ (+ (+ (+ (* -1.0 (expt ,a 2.0)) (* (* -3.0 ,b) ,d)) (* ,a ,e)) (* -1.0 (expt ,e 2.0)))
                                                                             (* (* -3.0 ,c) ,g)) (* (* -3.0 ,f) ,h)) (* ,a ,i)) (* ,e ,i)) (* -1.0 (expt ,i 2.0))))
                                                           (expt (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* 2.0 (expt ,a 3.0)) (* (* (* 9.0 ,a) ,b) ,d))
                                                                                                                             (* (* -3.0 (expt ,a 2.0)) ,e)) (* (* (* 9.0 ,b) ,d) ,e))
                                                                                                                       (* (* -3.0 ,a) (expt ,e 2.0))) (* 2.0 (expt ,e 3.0)))
                                                                                                                 (* (* (* 9.0 ,a) ,c) ,g)) (* (* (* -18.0 ,c) ,e) ,g))
                                                                                                           (* (* (* 27.0 ,b) ,f) ,g)) (* (* (* 27.0 ,c) ,d) ,h))
                                                                                                     (* (* (* -18.0 ,a) ,f) ,h)) (* (* (* 9.0 ,e) ,f) ,h))
                                                                                               (* (* -3.0 (expt ,a 2.0)) ,i)) (* (* (* -18.0 ,b) ,d) ,i)) (* (* (* 12.0 ,a) ,e) ,i))
                                                                                      (* (* -3.0 (expt ,e 2.0)) ,i)) (* (* (* 9.0 ,c) ,g) ,i)) (* (* (* 9.0 ,f) ,h) ,i))
                                                                             (* (* -3.0 ,a) (expt ,i 2.0))) (* (* -3.0 ,e) (expt ,i 2.0))) (* 2.0 (expt ,i 3.0)))
                                                                    (expt (+ (* 4.0 (expt (+ (+ (+ (+ (+ (+ (+ (+ (* -1.0 (expt ,a 2.0)) (* (* -3.0 ,b) ,d)) (* ,a ,e))
                                                                                                            (* -1.0 (expt ,e 2.0))) (* (* -3.0 ,c) ,g)) (* (* -3.0 ,f) ,h)) (* ,a ,i))
                                                                                                (* ,e ,i)) (* -1.0 (expt ,i 2.0))) 3.0))
                                                                             (expt (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* 2.0 (expt ,a 3.0)) (* (* (* 9.0 ,a) ,b) ,d))
                                                                                                                                            (* (* -3.0 (expt ,a 2.0)) ,e))
                                                                                                                                         (* (* (* 9.0 ,b) ,d) ,e)) (* (* -3.0 ,a) (expt ,e 2.0)))
                                                                                                                                   (* 2.0 (expt ,e 3.0))) (* (* (* 9.0 ,a) ,c) ,g))
                                                                                                                             (* (* (* -18.0 ,c) ,e) ,g)) (* (* (* 27.0 ,b) ,f) ,g))
                                                                                                                       (* (* (* 27.0 ,c) ,d) ,h)) (* (* (* -18.0 ,a) ,f) ,h))
                                                                                                                 (* (* (* 9.0 ,e) ,f) ,h)) (* (* -3.0 (expt ,a 2.0)) ,i))
                                                                                                           (* (* (* -18.0 ,b) ,d) ,i)) (* (* (* 12.0 ,a) ,e) ,i)) (* (* -3.0 (expt ,e 2.0)) ,i))
                                                                                                  (* (* (* 9.0 ,c) ,g) ,i)) (* (* (* 9.0 ,f) ,h) ,i)) (* (* -3.0 ,a) (expt ,i 2.0)))
                                                                                         (* (* -3.0 ,e) (expt ,i 2.0))) (* 2.0 (expt ,i 3.0))) 2.0)) (/ 1.0 2.0))) (/ -1.0 3.0))))
                    (* (* (/ 1.0 3.0) (expt 2.0 (/ -1.0 3.0))) (expt (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* 2.0 (expt ,a 3.0)) (* (* (* 9.0 ,a) ,b) ,d))
                                                                                                                                 (* (* -3.0 (expt ,a 2.0)) ,e)) (* (* (* 9.0 ,b) ,d) ,e))
                                                                                                                           (* (* -3.0 ,a) (expt ,e 2.0))) (* 2.0 (expt ,e 3.0)))
                                                                                                                     (* (* (* 9.0 ,a) ,c) ,g)) (* (* (* -18.0 ,c) ,e) ,g))
                                                                                                               (* (* (* 27.0 ,b) ,f) ,g)) (* (* (* 27.0 ,c) ,d) ,h)) (* (* (* -18.0 ,a) ,f) ,h))
                                                                                                      (* (* (* 9.0 ,e) ,f) ,h)) (* (* -3.0 (expt ,a 2.0)) ,i)) (* (* (* -18.0 ,b) ,d) ,i))
                                                                                             (* (* (* 12.0 ,a) ,e) ,i)) (* (* -3.0 (expt ,e 2.0)) ,i)) (* (* (* 9.0 ,c) ,g) ,i))
                                                                                    (* (* (* 9.0 ,f) ,h) ,i)) (* (* -3.0 ,a) (expt ,i 2.0))) (* (* -3.0 ,e) (expt ,i 2.0))) (* 2.0 (expt ,i 3.0)))
                                                                        (expt (+ (* 4.0 (expt (+ (+ (+ (+ (+ (+ (+ (+ (* -1.0 (expt ,a 2.0)) (* (* -3.0 ,b) ,d)) (* ,a ,e))
                                                                                                                (* -1.0 (expt ,e 2.0))) (* (* -3.0 ,c) ,g)) (* (* -3.0 ,f) ,h)) (* ,a ,i))
                                                                                                    (* ,e ,i)) (* -1.0 (expt ,i 2.0))) 3.0))
                                                                                 (expt (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* 2.0 (expt ,a 3.0)) (* (* (* 9.0 ,a) ,b) ,d))
                ...
                `(+ (+ (* (/ 1.0 3.0) (+ (+ ,a ,e) ,i)) (* (* (* (* (/ 1.0 3.0) (expt 2.0 (/ -2.0 3.0))) (+ 1.0 (* (make-rectangular 0.0 1.0) (expt 3.0 (/ 1.0 2.0)))))
                                                              (+ (+ (+ (+ (+ (+ (+ (+ (* -1.0 (expt ,a 2.0)) (* (* -3.0 ,b) ,d)) (* ,a ,e)) (* -1.0 (expt ,e 2.0)))
                                                                             (* (* -3.0 ,c) ,g)) (* (* -3.0 ,f) ,h)) (* ,a ,i)) (* ,e ,i)) (* -1.0 (expt ,i 2.0))))
                                                           (expt (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* 2.0 (expt ,a 3.0)) (* (* (* 9.0 ,a) ,b) ,d))
                                                                                                                             (* (* -3.0 (expt ,a 2.0)) ,e)) (* (* (* 9.0 ,b) ,d) ,e))
                                                                                         ...
                                                                                         (* (* (* 12.0 ,a) ,e) ,i)) (* (* -3.0 (expt ,e 2.0)) ,i)) (* (* (* 9.0 ,c) ,g) ,i))
                                                                                (* (* (* 9.0 ,f) ,h) ,i)) (* (* -3.0 ,a) (expt ,i 2.0))) (* (* -3.0 ,e) (expt ,i 2.0))) (* 2.0 (expt ,i 3.0)))
                                                                    (expt (+ (* 4.0 (expt (+ (+ (+ (+ (+ (+ (+ (+ (* -1.0 (expt ,a 2.0)) (* (* -3.0 ,b) ,d)) (* ,a ,e)) (* -1.0 (expt ,e 2.0)))
                                                                                                         (* (* -3.0 ,c) ,g)) (* (* -3.0 ,f) ,h)) (* ,a ,i)) (* ,e ,i)) (* -1.0 (expt ,i 2.0))) 3.0))
                                                                             (expt (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* 2.0 (expt ,a 3.0)) (* (* (* 9.0 ,a) ,b) ,d))
                                                                                                                                            (* (* -3.0 (expt ,a 2.0)) ,e)) (* (* (* 9.0 ,b) ,d) ,e))
                                                                                                                                      (* (* -3.0 ,a) (expt ,e 2.0))) (* 2.0 (expt ,e 3.0)))
                                                                                                                                (* (* (* 9.0 ,a) ,c) ,g)) (* (* (* -18.0 ,c) ,e) ,g))
                                                                                                              ...
                                                                                                              (* (* -3.0 (expt ,a 2.0)) ,i)) (* (* (* -18.0 ,b) ,d) ,i)) (* (* (* 12.0 ,a) ,e) ,i))
                                                                                                     (* (* -3.0 (expt ,e 2.0)) ,i)) (* (* (* 9.0 ,c) ,g) ,i)) (* (* (* 9.0 ,f) ,h) ,i))
                                                                                            (* (* -3.0 ,a) (expt ,i 2.0))) (* (* -3.0 ,e) (expt ,i 2.0))) (* 2.0 (expt ,i 3.0))) 2.0)) (/ 1.0 2.0)))
                                                                 (/ -1.0 3.0)))) (* (* (* (/ -1.0 6.0) (expt 2.0 (/ -1.0 3.0))) (+ 1.0 (* (make-rectangular 0.0 -1.0) (expt 3.0 (/ 1.0 2.0)))))
                                                                                    (expt (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* 2.0 (expt ,a 3.0))
                                                                                                                                                         (* (* (* 9.0 ,a) ,b) ,d))
                                                                                                                                                      (* (* -3.0 (expt ,a 2.0)) ,e))
                                                                                                                                                   (* (* (* 9.0 ,b) ,d) ,e))
                                                                                                                                    ...
                                                                                                                                    (* (* (* 27.0 ,b) ,f) ,g)) (* (* (* 27.0 ,c) ,d) ,h))
                                                                                                                              (* (* (* -18.0 ,a) ,f) ,h)) (* (* (* 9.0 ,e) ,f) ,h))
                                                                                                                        (* (* -3.0 (expt ,a 2.0)) ,i)) (* (* (* -18.0 ,b) ,d) ,i))
                                                                                                                  (* (* (* 12.0 ,a) ,e) ,i)) (* (* -3.0 (expt ,e 2.0)) ,i))
                                                                                                            (* (* (* 9.0 ,c) ,g) ,i)) (* (* (* 9.0 ,f) ,h) ,i)) (* (* -3.0 ,a) (expt ,i 2.0)))
                                                                                                   (* (* -3.0 ,e) (expt ,i 2.0))) (* 2.0 (expt ,i 3.0)))
                                                                                             (expt (+ (* 4.0 (expt (+ (+ (+ (+ (+ (+ (+ (+ (* -1.0 (expt ,a 2.0)) (* (* -3.0 ,b) ,d)) (* ,a ,e))
                                                                                                                                     (* -1.0 (expt ,e 2.0))) (* (* -3.0 ,c) ,g)) (* (* -3.0 ,f) ,h))
                                                                                                                            (* ,a ,i)) (* ,e ,i)) (* -1.0 (expt ,i 2.0))) 3.0))
                                                                                                      (expt (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* 2.0 (expt ,a 3.0))
                                                                                                                                                                        (* (* (* 9.0 ,a) ,b) ,d))
                                                                                                                                                                     (* (* -3.0 (expt ,a 2.0)) ,e))
                                                                                                                                                                  (* (* (* 9.0 ,b) ,d) ,e))
                                                                                                                                                ...
                                                                                                                                                (* (* (* 27.0 ,c) ,d) ,h)) (* (* (* -18.0 ,a) ,f) ,h))
                                                                                                                                          (* (* (* 9.0 ,e) ,f) ,h)) (* (* -3.0 (expt ,a 2.0)) ,i))
                                                                                                                                    (* (* (* -18.0 ,b) ,d) ,i)) (* (* (* 12.0 ,a) ,e) ,i))
                                                                                                                              (* (* -3.0 (expt ,e 2.0)) ,i)) (* (* (* 9.0 ,c) ,g) ,i))
                                                                                                                        (* (* (* 9.0 ,f) ,h) ,i)) (* (* -3.0 ,a) (expt ,i 2.0)))
                                                                                                                  (* (* -3.0 ,e) (expt ,i 2.0))) (* 2.0 (expt ,i 3.0))) 2.0))
                                                                                                   (/ 1.0 2.0))) (/ 1.0 3.0))))
                ...
                `(+ (+ (* (/ 1.0 3.0) (+ (+ ,a ,e) ,i)) (* (* (* (* (/ 1.0 3.0) (expt 2.0 (/ -2.0 3.0))) (+ 1.0 (* (make-rectangular 0.0 -1.0) (expt 3.0 (/ 1.0 2.0)))))
                                                           ...
                                                           (expt (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* 2.0 (expt ,a 3.0)) (* (* (* 9.0 ,a) ,b) ,d))
                                                                                                                             (* (* -3.0 (expt ,a 2.0)) ,e)) (* (* (* 9.0 ,b) ,d) ,e))
                                                                                                                       (* (* -3.0 ,a) (expt ,e 2.0))) (* 2.0 (expt ,e 3.0)))
                                                                                                                 (* (* (* 9.0 ,a) ,c) ,g)) (* (* (* -18.0 ,c) ,e) ,g)) (* (* (* 27.0 ,b) ,f) ,g))
                                                                                                        (* (* (* 27.0 ,c) ,d) ,h)) (* (* (* -18.0 ,a) ,f) ,h)) (* (* (* 9.0 ,e) ,f) ,h))
                                                                                               (* (* -3.0 (expt ,a 2.0)) ,i)) (* (* (* -18.0 ,b) ,d) ,i)) (* (* (* 12.0 ,a) ,e) ,i))
                                                                                      (* (* -3.0 (expt ,e 2.0)) ,i)) (* (* (* 9.0 ,c) ,g) ,i)) (* (* (* 9.0 ,f) ,h) ,i))
                                                                             (* (* -3.0 ,a) (expt ,i 2.0))) (* (* -3.0 ,e) (expt ,i 2.0))) (* 2.0 (expt ,i 3.0)))
                                                                    (expt (+ (* 4.0 (expt (+ (+ (+ (+ (+ (+ (+ (+ (* -1.0 (expt ,a 2.0)) (* (* -3.0 ,b) ,d)) (* ,a ,e)) (* -1.0 (expt ,e 2.0)))
                                                                 ...
                                                                 (/ -1.0 3.0)))) (* (* (* (/ -1.0 6.0) (expt 2.0 (/ -1.0 3.0))) (+ 1.0 (* (make-rectangular 0.0 1.0) (expt 3.0 (/ 1.0 2.0)))))
                                                                                    (expt (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* 2.0 (expt ,a 3.0))
                                                                                                                        ...
                                                                                                                        (* (* -3.0 (expt ,a 2.0)) ,i)) (* (* (* -18.0 ,b) ,d) ,i))
                                                                                                                  (* (* (* 12.0 ,a) ,e) ,i)) (* (* -3.0 (expt ,e 2.0)) ,i)) (* (* (* 9.0 ,c) ,g) ,i))
                                                                                                         (* (* (* 9.0 ,f) ,h) ,i)) (* (* -3.0 ,a) (expt ,i 2.0))) (* (* -3.0 ,e) (expt ,i 2.0)))
                                                                                                (* 2.0 (expt ,i 3.0))) (expt (+ (* 4.0 (expt (+ (+ (+ (+ (+ (+ (+ (+ (* -1.0 (expt ,a 2.0))
                                                                                                                                                                     (* (* -3.0 ,b) ,d)) (* ,a ,e))
                                                                                                                                                               (* -1.0 (expt ,e 2.0)))
                                                                                                                                                            (* (* -3.0 ,c) ,g))
                                                                                                                                                         (* (* -3.0 ,f) ,h)) (* ,a ,i)) (* ,e ,i))
                                                                                                             ...
                                                                                                             (expt (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* 2.0 (expt ,a 3.0))
                                                                                                                                     ...
                                                                                                                                     (* (* -3.0 (expt ,e 2.0)) ,i)) (* (* (* 9.0 ,c) ,g) ,i))
                                                                                                                               (* (* (* 9.0 ,f) ,h) ,i)) (* (* -3.0 ,a) (expt ,i 2.0)))
                                                                                                                         (* (* -3.0 ,e) (expt ,i 2.0))) (* 2.0 (expt ,i 3.0))) 2.0)) (/ 1.0 2.0)))
                                                                                          (/ 1.0 3.0)))))])])))
...
;; --------------------------------------------------------------------------------------------------------------------
;; Prove strict hyperbolicity of the Lax–Friedrichs (Finite-Difference) Solver for a 1D Coupled Vector System of 3 PDEs
;; --------------------------------------------------------------------------------------------------------------------
(define (prove-lax-friedrichs-vector3-1d-strict-hyperbolicity pde-system
                                                              #:nx [nx 200]
                                                              #:x0 [x0 0.0]
                                                              #:x1 [x1 2.0]
                                                              #:t-final [t-final 1.0]
  ...
  out)
(trace prove-lax-friedrichs-vector3-1d-strict-hyperbolicity)

;; -------------------------------------------------------------------------------------------------------------
;; Prove CFL stability of the Lax–Friedrichs (Finite-Difference) Solver for a 1D Coupled Vector System of 3 PDEs
;; -------------------------------------------------------------------------------------------------------------
(define (prove-lax-friedrichs-vector3-1d-cfl-stability pde-system
                                                       #:nx [nx 200]
                                                       #:x0 [x0 0.0]
                                                       #:x1 [x1 2.0]
                                                       #:t-final [t-final 1.0]
  ...
  (define out (cond
    ...
    [(or (equal? (member (list-ref flux-eigvals-simp 0) max-speed-exprs-simp) #f)
         (equal? (member (list-ref flux-eigvals-simp 1) max-speed-exprs-simp) #f)
         (equal? (member (list-ref flux-eigvals-simp 2) max-speed-exprs-simp) #f)) #f]
  ...
  out)
(trace prove-lax-friedrichs-vector3-1d-cfl-stability)
...
;; ---------------------------------------------------------------------------------------------------------------------------------------------------------
(define (prove-lax-friedrichs-vector3-1d-local-lipschitz pde-system
                                                         #:nx [nx 200]
                                                         #:x0 [x0 0.0]
                                                         #:x1 [x1 2.0]
                                                         #:t-final [t-final 1.0]
                                                         ...
                                                         #:init-funcs [init-funcs (list
                                                                                   ...
                                                                                   `(cond
                                                                                      [(< x 0.5) 7.5]
                                                                                      [else 2.5]))])
   "Prove that the Lax-Friedrichs finite-difference method has a discrete flux function that satisfies local Lipschitz continuity for the 1D coupled vector system of 3 PDEs specified by `pde-system`. 
  - `nx` : Number of spatial cells.
  - `x0`, `x1` : Domain boundaries.
  - `t-final`: Final time.
  - `cfl`: CFL coefficient.
  ...
  (define out (cond
    ...
    [(or (not (is-non-negative (list-ref hessian-eigvals-simp 0) cons-exprs parameters))
         ...
         (not (is-non-negative (list-ref hessian-eigvals-simp 3) cons-exprs parameters))
         (not (is-non-negative (list-ref hessian-eigvals-simp 4) cons-exprs parameters))
         (not (is-non-negative (list-ref hessian-eigvals-simp 5) cons-exprs parameters))
         (not (is-non-negative (list-ref hessian-eigvals-simp 6) cons-exprs parameters))
         (not (is-non-negative (list-ref hessian-eigvals-simp 7) cons-exprs parameters))
         (not (is-non-negative (list-ref hessian-eigvals-simp 8) cons-exprs parameters))) #f]
  ...
  out)
(trace prove-lax-friedrichs-vector3-1d-local-lipschitz)

;; ----------------------------------------------------------------------------------------------
;; Prove hyperbolicity of the Roe (Finite-Volume) Solver for a 1D Coupled Vector System of 3 PDEs
;; ----------------------------------------------------------------------------------------------
(define (prove-roe-vector3-1d-hyperbolicity pde-system
                                            #:nx [nx 200]
                                            #:x0 [x0 0.0]
                                            #:x1 [x1 2.0]
                                            #:t-final [t-final 1.0]
                                            ...
                                            #:init-funcs [init-funcs (list
                                                                      ...
                                                                      `(cond
                                                                         [(< x 0.5) 7.5]
                                                                         [else 2.5]))])
   "Prove that the Roe finite-volume method preserves hyperbolicity for the 1D coupled vector system of 3 PDEs specified by `pde-system`. 
  - `nx` : Number of spatial cells.
  - `x0`, `x1` : Domain boundaries.
  - `t-final`: Final time.
  - `cfl`: CFL coefficient.
  ...
  (define roe-matrix-eigvals (symbolic-eigvals3 (symbolic-roe-matrix (symbolic-jacobian flux-exprs cons-exprs) cons-exprs)))
  (define roe-matrix-eigvals-simp (list
                                   ...
                                   (symbolic-simp (list-ref roe-matrix-eigvals 2))))
  ...
  (define out (cond
    ...
    [(or (not (is-real (list-ref roe-matrix-eigvals-simp 0) (list
         ...
         (not (is-real (list-ref roe-matrix-eigvals-simp 1) (list
                                                             ...
                                                             (string->symbol (string-append (symbol->string (list-ref cons-exprs 2)) "L"))
                                                             (string->symbol (string-append (symbol->string (list-ref cons-exprs 2)) "R"))) parameters))
         (not (is-real (list-ref roe-matrix-eigvals-simp 2) (list
                                                             (string->symbol (string-append (symbol->string (list-ref cons-exprs 0)) "L"))
                                                             (string->symbol (string-append (symbol->string (list-ref cons-exprs 0)) "R"))
                                                             (string->symbol (string-append (symbol->string (list-ref cons-exprs 1)) "L"))
                                                             (string->symbol (string-append (symbol->string (list-ref cons-exprs 1)) "R"))
  ...
  out)
(trace prove-roe-vector3-1d-hyperbolicity)

;; -----------------------------------------------------------------------------------------------------
;; Prove strict hyperbolicity of the Roe (Finite-Volume) Solver for a 1D Coupled Vector System of 3 PDEs
;; -----------------------------------------------------------------------------------------------------
(define (prove-roe-vector3-1d-strict-hyperbolicity pde-system
                                                   #:nx [nx 200]
                                                   #:x0 [x0 0.0]
                                                   #:x1 [x1 2.0]
                                                   #:t-final [t-final 1.0]
                                                   ...
                                                   #:init-funcs [init-funcs (list
                                                                             ...
                                                                             `(cond
                                                                                [(< x 0.5) 7.5]
                                                                                [else 2.5]))])
   "Prove that the Roe finite-volume method preserves strict hyperbolicity for the 1D coupled vector system of 3 PDEs specified by `pde-system`. 
  - `nx` : Number of spatial cells.
  - `x0`, `x1` : Domain boundaries.
  - `t-final`: Final time.
  - `cfl`: CFL coefficient.
  ...
  (define out (cond
    ...
    [(not (are-distinct (list (list-ref roe-matrix-eigvals-simp 0) (list-ref roe-matrix-eigvals-simp 1)) parameters)) #f]
    [(not (are-distinct (list (list-ref roe-matrix-eigvals-simp 0) (list-ref roe-matrix-eigvals-simp 2)) parameters)) #f]
    [(not (are-distinct (list (list-ref roe-matrix-eigvals-simp 1) (list-ref roe-matrix-eigvals-simp 2)) parameters)) #f]
  ...
  out)
(trace prove-roe-vector3-1d-strict-hyperbolicity)

;; --------------------------------------------------------------------------------------------------------------------
;; Prove flux conservation (jump continuity) of the Roe (Finite-Volume) Solver for a 1D Coupled Vector System of 3 PDEs
;; --------------------------------------------------------------------------------------------------------------------
(define (prove-roe-vector3-1d-flux-conservation pde-system
                                                #:nx [nx 200]
                                                #:x0 [x0 0.0]
                                                #:x1 [x1 2.0]
                                                #:t-final [t-final 1.0]
                                                ...
                                                #:init-funcs [init-funcs (list
                                                                          ...
                                                                          `(cond
                                                                             [(< x 0.5) 7.5]
                                                                             [else 2.5]))])
  "Prove that the Roe finite-volume method preserves flux conservation (jump continuity) for the 1D coupled vector system of 3 PDEs specified by `pde-system`. 
  - `nx` : Number of spatial cells.
  - `x0`, `x1` : Domain boundaries.
  - `t-final`: Final time.
  - `cfl`: CFL coefficient.
  ...
  (define roe-jump (list (symbolic-simp `(+ (* ,(list-ref (list-ref roe-matrix 0) 0) ,(list-ref cons-jump 0))
                                            ...
                                            (* ,(list-ref (list-ref roe-matrix 0) 2) ,(list-ref cons-jump 2))))
                         (symbolic-simp `(+ (* ,(list-ref (list-ref roe-matrix 1) 0) ,(list-ref cons-jump 0))
                                            (* ,(list-ref (list-ref roe-matrix 1) 1) ,(list-ref cons-jump 1))
                                            (* ,(list-ref (list-ref roe-matrix 1) 2) ,(list-ref cons-jump 1))))
                         (symbolic-simp `(+ (* ,(list-ref (list-ref roe-matrix 2) 0) ,(list-ref cons-jump 0))
                                            (* ,(list-ref (list-ref roe-matrix 2) 1) ,(list-ref cons-jump 1))
                                            (* ,(list-ref (list-ref roe-matrix 2) 2) ,(list-ref cons-jump 1))))))

  (define flux-jump (list (symbolic-simp `(- ,(flux-deriv-replace (flux-deriv-replace
                          ...
                          (symbolic-simp `(- ,(flux-deriv-replace (flux-deriv-replace
                                               ...
                                               ,(flux-deriv-replace (flux-deriv-replace
                                                                    ...
                                                                    (list-ref cons-exprs 2) (string->symbol (string-append (symbol->string (list-ref cons-exprs 2)) "R")))))
                          (symbolic-simp `(- ,(flux-deriv-replace (flux-deriv-replace
                                                                   (flux-deriv-replace (list-ref flux-exprs 2) (list-ref cons-exprs 0)
                                                                                       (string->symbol (string-append (symbol->string (list-ref cons-exprs 0)) "L")))
                                                                   (list-ref cons-exprs 1) (string->symbol (string-append (symbol->string (list-ref cons-exprs 1)) "L")))
                                                                  (list-ref cons-exprs 2) (string->symbol (string-append (symbol->string (list-ref cons-exprs 2)) "L")))
                                             ,(flux-deriv-replace (flux-deriv-replace
  ...
  (define out (cond
    ...
    [(or (not (equal? (list-ref roe-jump 0) (list-ref flux-jump 0)))
         (not (equal? (list-ref roe-jump 1) (list-ref flux-jump 1)))
         (not (equal? (list-ref roe-jump 2) (list-ref flux-jump 2)))) #f]
  ...
  out)
(trace prove-roe-vector3-1d-flux-conservation)